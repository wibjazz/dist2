...
<title>Grafik Penjualan Tradisional Periode <?php echo $_POST['bulan_awal']; ?> - <?php echo $_POST['bulan_akhir']; ?></title>
...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         ...
         title: {
            text: 'Data PO Per Tradisional Store'
         },
         xAxis: {
            categories: ['Outlet']
         },
         yAxis: {
            ...
            [
<?php 
$sql   = "SELECT id_outlet, COUNT( id_orders_t ) AS qty FROM orders_t where tgl_order_t between '$_POST[bulan_awal]' and '$_POST[bulan_akhir]' GROUP BY id_outlet";

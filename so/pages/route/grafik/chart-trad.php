...
<title>Grafik Penjualan Tradisional <?php echo $bulan; ?></title>
...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         ...
         yAxis: {
            ...
            [
<?php 
$sql   = "SELECT id_outlet, COUNT( id_orders_t ) AS qty FROM orders_t where month(tgl_order_t) = '$_POST[bulan]' GROUP BY id_outlet";

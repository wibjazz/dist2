    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Outlet / Toko Tradisional</li>
        </ol>
      </section>
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Data Outlet / Toko Tradisional</h3><br />
                <button class="btn btn-primary" onclick="window.location='main.php?route=outlet-trad&act=tambah'"><i class="fa fa-plus"></i> Tambah Data</button>
              </div><!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php
					//jadwal
                   // $jadwal=mysql_query("SELECT * from outlet where employee_number='$_SESSION[employee_number]' order by id_outlet asc");
                   $jadwal=mysql_query("SELECT * from outlet where jenis_outlet='tradisional' order by id_outlet asc");
                   $no=1;
                   while($j=mysql_fetch_array($jadwal))
                   {
                    ...
                    <tr align="left">
                      ...
                      ?>
                      <td><?php echo $j['jenis_outlet']; ?></td>
                      <td><?php echo $s['name_e']; ?></td>
                      <td><a href="main.php?route=outlet-trad&act=edit&id=<?php echo $j['id_outlet']; ?>" title="Edit"><button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a></td>
                    </tr>
                    <?php
                    $no++;
                  }
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <form role="form" action="route/data_outlet/aksi_outlet.php?route=outlet-trad&act=input" method="post">
                <!-- text input -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <form role="form" action="route/data_outlet/aksi_outlet.php?route=outlet-trad&act=update" method="post">
                <!-- text input -->
                <div class="form-group">

            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Outlet / Toko Modern</h3><br />
                  <button class="btn btn-primary" onclick="window.location='main.php?route=outlet-mod&act=tambah'"><i class="fa fa-plus"></i> Tambah Data</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php
					//jadwal
					$jadwal=mysql_query("SELECT * from outlet order by id_outlet desc");
					$no=1;
                    ...
                    ?>
                        ...
                        <td><a href="main.php?route=outlet-mod&act=edit&id=<?php echo $j['id_outlet']; ?>" title="Edit"><button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a> <a href="route/data_outlet/aksi_outlet.php?route=outlet-mod&act=hapus&id=<?php echo $j['id_outlet']; ?>" title="Hapus"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
                      </tr>
					 <?php
					 $no++;
					 }

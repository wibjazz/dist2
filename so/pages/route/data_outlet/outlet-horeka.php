    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Outlet Horeka</li>
          </ol>
        </section>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Outlet / Toko Horeka</h3><br />
                  <button class="btn btn-primary" onclick="window.location='main.php?route=outlet-horeka&act=tambah'"><i class="fa fa-plus"></i> Tambah Data</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php
					//jadwal
					$jadwal=mysql_query("select * from outlet where jenis_outlet='horeka' order by id_outlet asc");
					$no=1;
                    ...
                    ?>
                        ...
                        <td><a href="main.php?route=outlet-horeka&act=edit&id=<?php echo $j['id_outlet']; ?>" title="Edit"><button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a> <a href="route/data_outlet/aksi_outlet.php?route=outlet-horeka&act=hapus&id=<?php echo $j['id_outlet']; ?>" title="Hapus"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
                      </tr>
					 <?php
					 $no++;
					 }
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form role="form" action="route/data_outlet/aksi_outlet.php?route=outlet-horeka&act=input" method="post">
                    <!-- text input -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form role="form" action="route/data_outlet/aksi_outlet.php?route=outlet-horeka&act=update" method="post">
                    <!-- text input -->
                    <div class="form-group">

...
<body>
  <?php
  $produksi = mysql_query("SELECT * from payment where tgl_order between '$_POST[bulan_awal]' AND '$_POST[bulan_akhir]' AND employee_number='$_SESSION[employee_number]' ");
...
?>
<p align="center">copyright &copy; 2020 System CDC</p>
</body>
</html>
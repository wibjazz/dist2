          ...
          <div class="col-md-12">              
            <div class="box box-warning">
              <div class="box-header">
                <h3 class="box-title">*Laporan Penjualan Sales per Periode</h3>
              </div><!-- /.box-header -->
              <div class="box-body">
                <form role="form" action="main.php?route=laporan-sales-outlet&act=view3" method="post">
                  <!-- text input -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select name="en" style="width:400px;">
                        <?php
                                //produk
                                // $produk=mysql_query("select * from produk where jenis = 'Produk' order by nama_produk asc");
                        //$produk=mysql_query("SELECT * from employee where id_jabatan='3' order by name_e asc");
                        $produk=mysql_query("SELECT * from employee inner join user_login on employee.employee_number=user_login.employee_number where employee.id_jabatan='3' and user_login.aktif='1' ");
                        while($pro=mysql_fetch_array($produk))
                        {
                          echo"<option value='$pro[employee_number]'>$pro[name_e] </option>";
                        }
                        ?>
                      </select>
                    </div><!-- /.input group -->
...
//Form Tambah Transaksi Umrah
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <!--<img src="../images/logo1.jpg" />--> Aplikasi ERP v.1 CDC
...
<?php
$employee=mysql_query("SELECT * from employee where employee_number='$_POST[en]'");
$e=mysql_fetch_array($employee);
?>
      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title">Laporan Penjualan Sales Outlet Periode : <?php echo tgl_indo($_POST['bulan_awal']); ?> - <?php echo tgl_indo($_POST['bulan_akhir']); ?></h3>
            <h2 class="box-header " style="padding: 2px; margin-top:2px ;margin-bottom:2px">Sales : <?php echo $e['name_e']; ?></h2>
...
<div class="box-body table-responsive">
  <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
     ...
     $orders=mysql_query("SELECT id_outlet , id_orders ,ppn , SUM(total_bayar) as totbar  from orders where tgl_order BETWEEN '$_POST[bulan_awal]' and '$_POST[bulan_akhir]' and employee_number='$_POST[en]' group by id_orders ");
     ...
     while($p=mysql_fetch_array($orders))
     {
      ...
      <tr align="left">
        ...
        <td><?php echo $out['nama_outlet']; ?></td>
        <td><?php echo $out['alamat_outlet']; ?></td>
        <!-- <td align="right">Rp. <?php echo format_rupiah($p['totbar']); ?></td>  -->
        <td align="right">Rp. <?php echo format_rupiah($grantotal); ?></td> 

        <td><a href="main.php?route=laporan-sales-outlet&act=view31&awal=<?php echo $awal; ?>&akhir=<?php echo $akhir; ?>&id=<?php echo $p['id_outlet']; ?>"><button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a></td>
        <!-- <td><a href="main.php?route=laporan-sales-outlet&act=view31&id=<?php echo $p['id_outlet']; ?>"><button class="btn btn-primary"><i class="fa fa-search"></i> Detail</button></a></td> -->
      </tr>
      <?php
  ...
  <td align="right"><strong>Rp. <?php echo format_rupiah($totppn+$total); ?></strong></td>
</table>

<input type="button" name="kembali" class="btn btn-primary" value="Kembali ..." onclick="location.href = 'main.php?route=laporan-sales-outlet&act';" style="cursor:pointer;" />
<br />
</div><!-- /.box-body -->
...
$awal=$_GET['awal'];
$akhir=$_GET['akhir'];
$employee=mysql_query("SELECT * from outlet where id_outlet='$_GET[id]'");
$e=mysql_fetch_array($employee);
?>
      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title">Laporan Penjualan Sales Outlet Periode : <?php echo tgl_indo($_GET['awal']); ?> - <?php echo tgl_indo($_GET['akhir']); ?></h3> 
            <h2 class="box-header " style="padding: 2px; margin-top:2px ;margin-bottom:2px"><?php echo $e['nama_outlet']; ?></h2><br/>
...
<div class="box-body">
  <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      $orders_detail=mysql_query("SELECT * from orders where tgl_order BETWEEN '$_GET[awal]' and '$_GET[akhir]' and id_outlet = '$_GET[id]'  ");
          // $orders_detail=mysql_query("SELECT *  from orders where  id_outlet = '$_GET[id]' ");
      ...
      while($p=mysql_fetch_array($orders_detail))
      {
        ...
        $pay=mysql_query("SELECT * from payment where id_orders='$p[id_orders]' ");
        $y=mysql_fetch_array($pay);
            //employee
            //$employee=mysql_query("select * from employee where employee_number='$out[employee_number]'");
            // $employee=mysql_query("select * from employee where employee_number='$_POST[en]'");
            // $e=mysql_fetch_array($employee);
        ...
        <tr align="left">
          ...
          <td><?php echo $p['tgl_jth_tempo']; ?></td>
          <td><?php echo $p['tgl_expired_po']; ?></td>
          <td><?php echo $p['status_orders']; ?></td>
          <td align="right">Rp. <?php echo format_rupiah($y['sisa_bayar']); ?></td> 
          <td align="right">Rp. <?php echo format_rupiah($y['total_bayar']); ?></td> 
          <td><?php echo $y['status_payment']; ?></td>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <!--<img src="../images/logo3.jpg" />--> Aplikasi ERP v.1 CDC
      <small>View Report</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="main.php?route=home"><i class="fa fa-home"></i> Beranda</a></li>

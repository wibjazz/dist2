  ...
  <head>
    ...
    <title>Cetak Laporan Rincian Penjualan Hari ini</title>
  ...
  <body>
    ...
    ?>
    <p align="center"><img src="<?php echo $dir;?>images/logo.png" width="100px"></p>
    <p align="center" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;"><b>LAPORAN PENJUALAN HARI INI</b></p>
    <p align="center" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;"><b>PERIODE <?php echo tgl_indo($awal); ?></b></p>
    <div class="table-responsive">
      <table width="100%" class="table1">
        ...
        <tbody>
         <?php
					//orders
         $orders=mysql_query("SELECT * from orders where tgl_order = '$awal' and employee_number='$en' ");
         ...
         while($or=mysql_fetch_array($orders))
         {
          ...
          <tr align="left">
            ...
            <td>Rp. <?php echo format_rupiah($or['total_bayar']); ?></td>              
          </tr>
          <?php
          $no++;
        }
